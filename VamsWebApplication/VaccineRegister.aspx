<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VaccineRegister.aspx.cs" Inherits="VamsWebApplication.VaccineRegister" %>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="form-group">
                            <!--<input type="submit" name="submit" id="submit" class="form-submit" value="Sign up"/>-->
                            <asp:Button ID="btnCancel" runat="server"  class="form-submit"  Text="Cancel Appointment" OnClick="btnCancel_Click" />
