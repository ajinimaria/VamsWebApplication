<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VaccineDelete.aspx.cs" Inherits="VamsWebApplication.VaccineDelete" %>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <h2 id="heading" runat="server" class="form-title">Vaccine Registration</h2>
                    ...
                    <div class="form-group">
                            <asp:TextBox ID="txtDate" class="form-input"  placeholder="Choose Date" textmode="Date" runat="server"></asp:TextBox>
                        </div> 
                     <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <asp:Button ID="btnCancel" runat="server"  class="form-submit"  Text="Delete Appointment" OnClick="btnCancel_Click" />
