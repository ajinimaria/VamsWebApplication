<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="VamsWebApplication.Report" %>
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <div class="form-group">
                         ...
                         <Columns>    
                             <asp:BoundField DataField="ClinicName" HeaderText="Clinic Name" ItemStyle-Width="30" />    
                             <asp:BoundField DataField="ClinicAddress" HeaderText="Clinic Address" ItemStyle-Width="150" />    
                             <asp:BoundField DataField="VaccineName" HeaderText="Vaccine Name" ItemStyle-Width="150" />   
                              <asp:BoundField DataField="Stock" HeaderText="Vaccine Quantity" ItemStyle-Width="150" />
                         </Columns>    
                     </asp:GridView>    
