<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VaccineDisplay.aspx.cs" Inherits="VamsWebApplication.VaccineDisplay" %>
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    ...
                    <h2 class="form-title">Vaccine Stock Report</h2>
                    <div class="form-group">
                         <asp:GridView ID="gvVaccine" runat="server" AutoGenerateColumns="false">    
                         <Columns>    
                             <asp:BoundField DataField="ClinicName" HeaderText="Clinic" ItemStyle-Width="30" />    
                             <asp:BoundField DataField="VaccineName" HeaderText="Vaccine" ItemStyle-Width="150" />    
                             <asp:BoundField DataField="PriorityName" HeaderText="Priority" ItemStyle-Width="150" />   
                              <asp:BoundField DataField="TargetPopulation" HeaderText="Target Population" ItemStyle-Width="150" />
