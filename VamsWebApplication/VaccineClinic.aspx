<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VaccineClinic.aspx.cs" Inherits="VamsWebApplication.VaccineClinic" %>
...
<body>
     <form id="FormVaccineClinic" runat="server">
        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <h2 class="form-title">Add new vaccine Clinic</h2>
                        <div class="form-group">
                            <asp:TextBox ID="txtName" class="form-input" placeholder="Name" runat="server"></asp:TextBox>
                            <p id="errLabelName" class="message" style="color:red;display:inline;float:left;display:none" >This field should not be empty!</p>
                        </div>                    
                        <div class="form-group">
                            <asp:TextBox ID="txtAddress" class="form-input"  placeholder="Clinic Address" runat="server"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <asp:TextBox ID="txtEmail" class="form-input"  placeholder="Contact Email" runat="server"></asp:TextBox>
                            <p id="errLabelEmail" class="message" style="color:red;display:inline;float:left;display:none" >This field should not be empty!</p>
                        </div>
                        <div class="form-group">
                            <asp:TextBox ID="txtPhone" class="form-input"  placeholder="Contact Phone" runat="server"></asp:TextBox>
                            <p id="errLabelPhone" class="message" style="color:red;display:inline;float:left;display:none" >This field should not be empty!</p>
                        </div> 
                        <div class="form-group">
                            <asp:TextBox ID="txtNoPeopleHourly" class="form-input"  placeholder="Number of people that can accomodate in an hour" runat="server"></asp:TextBox>
                            <p id="errLabelPeople" class="message" style="color:red;display:inline;float:left;display:none" >This field should not be empty!</p>
                        </div>   
                        <div class="form-group">
                            <!--<input type="submit" name="submit" id="submit" class="form-submit" value="Sign up"/>-->
                            <asp:Button ID="btnAddClinic" runat="server"  class="form-submit"  Text="Submit" OnClick="btnAddClinic_Click"  OnClientClick="return ValidateAddClinic()"/>
