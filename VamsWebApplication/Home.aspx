<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="VamsWebApplication.Home" %>
                ...
                <div class="signup-content">
                    ...
                    <h3 id="welcome" runat="server" class="form-title"></h3>  
                        <div class="form-group">
                            ...
                            <asp:Button ID="btnAddClinic" runat="server"  class="form-submit"  Text="Add Vaccine Clinic" OnClick="btnAddClinic_Click"  />
                        </div>
                        <div class="form-group">
                            <!--<input type="submit" name="submit" id="submit" class="form-submit" value="Sign up"/>-->
                            <asp:Button ID="btnAddVaccineStock" runat="server"  class="form-submit"  Text="Add Vaccine Stock" OnClick="btnAddVaccineStock_Click" />
                        </div>
                    <div class="form-group">
                            <!--<input type="submit" name="submit" id="submit" class="form-submit" value="Sign up"/>-->
                            <asp:Button ID="btnReport" runat="server"  class="form-submit"  Text="Show Reports" OnClick="btnReport_Click" />
                        </div>
